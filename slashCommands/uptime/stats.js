...
module.exports = {
  ...
  run: async (client, interaction, args) => {
    ...
    if (!errors) {
      interaction.followUp({ embeds: [new MessageEmbed().setColor("GREEN").setTitle(`${correctembedemoji} | Done`).setDescription("📥 Check your dms.").setFooter(interaction.member.user.tag).setThumbnail(client.user.displayAvatarURL())] });
    }
  },
};
